...
# Hoja individual FRIDA
HOJA_FRIDA_STRIKE_NORA = 'Frida-Strike-Nova'
# Columnas FRIDA
COLUMNAS_FRIDA_STRIE_NORA = [
    'ENVIO',
    'Excedente Kg',
    'Excedente x bulto',
    'PICK&PAD',
...
def process_etl():
    ...
    # ws = wb[HOJA_FRIDA_STRIKE_NORA]

    # maskFrida1 = df['Tipo de servicio'].isin('NORMAL AMBA/NEXT DAY')
    # maskFrida2 = df['Tipo de servicio'].isin('Same day/Flex')
